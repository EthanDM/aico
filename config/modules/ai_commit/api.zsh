...
#
# api.zsh - OpenAI API Integration for AI Commit
#
# This module handles all interactions with the OpenAI API, including:
# - API request validation and prerequisites
# - Request formatting and sending
# - Response parsing and error handling
# - Commit message extraction and cleaning
#
# Dependencies:
...
$diff_content"
    ...
    log_info "Generating commit message using $model..." >&2  # Send to stderr
